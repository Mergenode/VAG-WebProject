...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gorsel: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::banner.banner'
...
export interface ApiMarkaMarka extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::marka.marka'> &
      Schema.Attribute.Private;
...
export interface ApiYedekParcaYedekParca extends Struct.CollectionTypeSchema {
  collectionName: 'yedek_parcas';
  info: {
    displayName: 'Yedek Parca';
    pluralName: 'yedek-parcas';
    singularName: 'yedek-parca';
  };
  options: {
    draftAndPublish: true;
  };
